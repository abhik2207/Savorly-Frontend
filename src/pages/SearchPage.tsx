...
export default function SearchPage() {
    ...
    const setSortOption = (sortOptions: string) => {
        setSearchState((prevState) => ({
            ...prevState, sortOptions, page: 1
        }));
    }
    ...
    const setSearchQuery = (searchFormData: SearchForm) => {
        setSearchState((prevState) => ({
            ...prevState, searchQuery: searchFormData.searchQuery, page: 1
        }));
    }

    const resetSearch = () => {
        setSearchState((prevState) => ({
            ...prevState, searchQuery: "", page: 1
        }));
    }
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-5">
            <div id="cuisines-list">
                <CuisinesFilter isExpanded={isExpanded} onExpandedClicked={() => setIsExpanded((prev) => !prev)} selectedCuisines={searchState.selectedCuisines} onChange={setSelectedCuisines} />
            </div>
            <div id="main-content" className="flex flex-col gap-5">
                ...
                <div className="flex flex-col justify-between gap-3 lg:flex-row">
                    ...
                    <SortOptionsDropdown onChange={(value) => setSortOption(value)} sortOptions={searchState.sortOptions} />
                </div>
